...
rule phabox_identification:
    ...
    params: 
        ...
        database_dir = path.join(virshimeome_dir, "data", "phabox", "database"),
        parameter_dir = path.join(virshimeome_dir, "data", "phabox", "parameters")
    # conda:
